/**
 * Vendor Home — skeleton placeholder
 * Shows role confirmation + logout (mirrors web business/page.tsx)
 */
...
export default function VendorHomeScreen() {
  ...
  return (
    <View style={[s.root, { paddingTop: insets.top }]}>
      ...
      {/* Header */}
      <View style={s.header}>
        <Text style={s.brand}>Ruxstar Business</Text>
      ...
      <View style={s.body}>
        <View style={s.roleChip}>
          <Text style={s.roleChipText}>🏪  Vendor</Text>
        </View>
        <Text style={s.comingSoon}>Vendor dashboard — coming soon</Text>
      </View>
    </View>
  );
}
